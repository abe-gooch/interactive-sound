        ...
        "boxes": [
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 1103.0, 494.0, 120.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 849.0, 446.0, 237.0, 182.0 ],
                    "sync": 1
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 914.0, 382.0, 150.0, 48.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "jit_matrix", "" ],
                    "patching_rect": [ 843.0, 377.0, 56.0, 22.0 ],
                    "text": "jit.absdiff"
                }
            },
            {
                "box": {
                    ...
                    "numinlets": 1,
                    "numoutlets": 0,
                    "patching_rect": [ 887.0, 339.0, 94.0, 20.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 846.0, 338.0, 29.5, 22.0 ],
                    "text": "t l l"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 62.0, 472.0, 80.0, 36.0 ]
                }
            },
            {
                "box": {
